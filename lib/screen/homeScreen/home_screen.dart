...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String _getServiceImage(String tag) {
    ...
    return PngAssetPath.starImg;
  }

  String selectedXpressOption = "all";
  ...
  void initState() {
    ...
    // Ensure addresses are loaded at least once
    if (_addressController.addresses.isEmpty && !_addressController.isLoading.value) {
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return ZoomIn(
                        ...
                        child: InkWell(
                          onTap: () {
                            setState(() {
                              selectedXpressOption =
                                  xpressOptions[index]['id']!;
                            });
                          },
  ...
  Widget topAndBanner() {
    final double topInset = MediaQuery.of(Get.context!).padding.top;
    return Container(
      padding: EdgeInsets.only(top: topInset + 12, left: 12, right: 12, bottom: 16),
      decoration: BoxDecoration(
        color: AppColors.white,
          ...
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Obx(() {
                    final addr = AddressController.to.selectedAddress.value;
                    final title = (addr != null && addr.label.isNotEmpty)
                        ? addr.label
                        : 'Select Address';
                    final line = addr?.address ?? '';
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        InkWell(
                        ...
                        TextWidget(
                          text: line.isNotEmpty ? line : 'Tap to select your address',
                          textSize: 12,
