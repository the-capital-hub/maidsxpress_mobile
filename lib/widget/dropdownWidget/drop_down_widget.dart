    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          //   border: Border.all(color: AppColors.blackBorder, width: 1),
          // ),
          child: DropdownButtonFormField(
            decoration: InputDecoration(
              enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(widget.circleVal ?? 10),
                  borderSide:
                      BorderSide(color: AppColors.blackBorder, width: 1)),
              ...
              contentPadding: EdgeInsets.symmetric(
                  horizontal: 10, vertical: 12), // Control left padding here
            ),
            hint: TextWidget(
